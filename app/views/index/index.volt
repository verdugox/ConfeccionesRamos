...
<!-- PRELOADER -->
{{ image("img/preloader.gif","id":"preloader","alt": "") }}
<!-- //PRELOADER -->
<div class="preloader_hide">
	...
	<div id="page">
		...
		<section id="home" class="padbot0">
			...
			<div id="carousel">
				<ul class="slides">
					<li>{{ image("img/slider/slide1_bg.jpg","alt": "") }}</li>
					<li>{{ image("img/slider/slide2_bg.jpg","alt": "") }}</li>
					<li>{{ image("img/slider/slide3_bg.jpg","alt": "") }}</li>
				</ul>
			</div><!-- //TOP SLIDER -->
		</section><!-- //HOME -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-5 col-md-5 col-sm-5 ipad_img_in" data-appear-top-offset="-200" data-animated="fadeInRight">
							{{ image("img/img1.png","class":"ipad_img1","alt": "") }}
						</div>
					</div><!-- //ROW -->
				</div><!-- //CONTAINER -->
			</div><!-- //MULTI PURPOSE -->
				...
				<div class="container" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							{{ image("img/clients/1.jpg","alt": "") }}
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
						  {{ image("img/clients/2.jpg","alt": "") }}
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
						  {{ image("img/clients/3.jpg","alt": "") }}
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							{{ image("img/clients/4.jpg","alt": "") }}
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
						  {{ image("img/clients/5.jpg","alt": "") }}
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
						  {{ image("img/clients/6.jpg","alt": "") }}
						</div>
					</div><!-- //ROW -->
				</div><!-- CONTAINER -->
			</div><!-- //OUR CLIENTS -->
